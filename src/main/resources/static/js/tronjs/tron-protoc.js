...
},{"./src/main/genjs/TronAll_pb":3}],2:[function(require,module,exports){
(function (global){
...
},{"./api/api_pb.js":4,"./core/Contract_pb.js":5,"./core/Discover_pb.js":6,"./core/TronInventoryItems_pb.js":7,"./core/Tron_pb.js":8,"google-protobuf":2}],4:[function(require,module,exports){
(function (global){
/**
 * @fileoverview
 * @enhanceable
...
proto.protocol.AccountList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.protocol.Account.toObject, includeInstance)
  };
...
proto.protocol.AccountList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.protocol.Account;
      reader.readMessage(value,proto.protocol.Account.deserializeBinaryFromReader);
...
proto.protocol.AccountList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.protocol.Account.serializeBinaryToWriter
    );
  }
};
...
proto.protocol.AccountList.prototype.getAccountsList = function() {
  return /** @type{!Array.<!proto.protocol.Account>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.protocol.Account, 1));
};
...
proto.protocol.WitnessList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.protocol.Witness.toObject, includeInstance)
  };
...
proto.protocol.WitnessList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.protocol.Witness;
      reader.readMessage(value,proto.protocol.Witness.deserializeBinaryFromReader);
...
proto.protocol.WitnessList.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.protocol.Witness.serializeBinaryToWriter
    );
  }
};
...
proto.protocol.WitnessList.prototype.getWitnessesList = function() {
  return /** @type{!Array.<!proto.protocol.Witness>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.protocol.Witness, 1));
};
...
proto.protocol.AssetIssueList.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.protocol.AssetIssueContract.toObject, includeInstance)
  };
...
proto.protocol.AssetIssueList.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.protocol.AssetIssueContract;
      reader.readMessage(value,proto.protocol.AssetIssueContract.deserializeBinaryFromReader);
...
proto.protocol.AssetIssueList.prototype.getAssetissueList = function() {
  return /** @type{!Array.<!proto.protocol.AssetIssueContract>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.protocol.AssetIssueContract, 1));
};
